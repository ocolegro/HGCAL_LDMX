...
outDir = '/data/cmszfs1/user/hiltbran/HGCAL_LDMX/PFCalEE/events/lheFiles/photons' 

usage = 'usage: %prog [options]'
parser = optparse.OptionParser(usage)
parser.add_option('-f', '--filename', dest='filename', help='lhe file name', default='photons')
...
for i in range(0,opt.nevts):
    ...
    lhefile.write('22 %f %f -50 0 0 1 %g\n'%(x,y,opt.energy))
